...
router.post(
  ...
  async (req, res) => {
    ...
    // var result = await axios.get('https://teacherstaffapi.herokuapp.com/staff')
    // for(let i=0 ; i<Object.keys(result).length ; i++){
    //   // console.log(result.data[i])
    //   var teacher = new Teacher(result.data[i]);
...
router.get('/teacherdetails' ,  async (req , res)=>{
  const result = await axios.get('https://teacherstaffapi.herokuapp.com/staff')
